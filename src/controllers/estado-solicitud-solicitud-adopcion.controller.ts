...
export class EstadoSolicitudSolicitudAdopcionController {
  ...
  async find(
    ...
    return this.estadoSolicitudRepository.solicitudAdopciones(id).find(filter);
  }
  ...
  async create(
    ...
    return this.estadoSolicitudRepository.solicitudAdopciones(id).create(solicitudAdopcion);
  }
  ...
  async patch(
    ...
    return this.estadoSolicitudRepository.solicitudAdopciones(id).patch(solicitudAdopcion, where);
  }
  ...
  async delete(
    ...
    return this.estadoSolicitudRepository.solicitudAdopciones(id).delete(where);
  }
}
