...
export class PersonaSolicitudAdopcionController {
  ...
  async find(
    ...
    return this.personaRepository.solicitudAdopciones(id).find(filter);
  }
  ...
  async create(
    ...
    return this.personaRepository.solicitudAdopciones(id).create(solicitudAdopcion);
  }
  ...
  async patch(
    ...
    return this.personaRepository.solicitudAdopciones(id).patch(solicitudAdopcion, where);
  }
  ...
  async delete(
    ...
    return this.personaRepository.solicitudAdopciones(id).delete(where);
  }
}
